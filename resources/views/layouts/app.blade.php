...
<!-- Bootstrap 4 -->
<script src="p{{ url('ublic/assets/plugins/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
<!-- ChartJS -->
...
<!-- daterangepicker -->
<script src="{{ url('public/assets/public/assets/plugins/moment/moment.min.js') }}"></script>
